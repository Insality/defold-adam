...
---@return ActionInstance
function adam__actions.animate_scale(target_scale, time, finish_event, delay, ease_function) end
...
---@return ActionInstance
function adam__actions.broadcast_event(event_name, is_exclude_self, delay) end
...
---@return ActionInstance
function adam__actions.create_object(factory_url, position, variable, delay, scale, rotation, properties) end
...
---@return ActionInstance
function adam__actions.delay(seconds, trigger_event) end
...
---@return ActionInstance
function adam__actions.delete_object(target, delay, not_recursive) end
...
---@param not_recursive boolean Set true to not delete children of deleted go
---@return ActionInstance
function adam__actions.delete_self(delay, not_recursive) end

--- Enable the receiving component
---@param target url The game object to delete, self by default
---@param delay number Delay before delete
---@return ActionInstance
function adam__actions.disable_object(target, delay) end
...
---@param delay number Delay before delete
---@return ActionInstance
function adam__actions.enable_object(target, delay) end

--- Instantly trigger event.
---@param event_name string The event to send
---@return ActionInstance
function adam__actions.event(event_name) end

--- Trigger event after amount of frames.
---@param frames number Amount of frames to wait
---@param trigger_event string Name of trigger event
---@return ActionInstance
function adam__actions.frames(frames, trigger_event) end
...
---@return ActionInstance
function adam__actions.get_action(action_id, variable, in_update_only, trigger_event) end
...
---@param trigger_event string The event to trigger on true condition
---@return ActionInstance
function adam__actions.get_action_pressed(action_id, variable, in_update_only, trigger_event) end
...
---@param trigger_event string The event to trigger on true condition
---@return ActionInstance
function adam__actions.get_action_released(action_id, variable, in_update_only, trigger_event) end
...
---@return ActionInstance
function adam__actions.get_axis_actions(negative_action, positive_action, variable, is_every_frame, multiplier) end
...
---@param trigger_event string The event to trigger on true condition
---@return ActionInstance
function adam__actions.get_sprite_action(action_id, sprite_url, variable, in_update_only, trigger_event) end
...
---@param trigger_event string The event to trigger on true condition
---@return ActionInstance
function adam__actions.get_sprite_action_pressed(action_id, sprite_url, variable, in_update_only, trigger_event) end
...
---@param trigger_event string The event to trigger on true condition
---@return ActionInstance
function adam__actions.get_sprite_action_released(action_id, sprite_url, variable, in_update_only, trigger_event) end
...
---@return ActionInstance
function adam__actions.post(target, message_id, message, delay) end

--- Print text to console
---@param text string The log message
---@param is_every_second bool Repeat this action every second
---@return ActionInstance
function adam__actions.print(text, is_every_second) end
...
---@return ActionInstance
function adam__actions.send_event(target, event_name, delay, is_every_frame) end
...
---@param ease_function ease The ease function to animate. Default in settings.get_default_easing
---@return ActionInstance
function adam__actions.set_position(target_vector, is_every_frame, delay, ease_function) end
...
---@param ease_function ease The ease function to animate. Default in settings.get_default_easing
---@return ActionInstance
function adam__actions.set_scale(target_scale, is_every_frame, delay, ease_function) end
...
---@param is_every_frame boolean Repeat this action every frame
---@return ActionInstance
function adam__actions.set_xyz(source, value_x, value_y, value_z, is_every_frame) end
...
---@param ease_function ease The ease function to animate. Default in settings.get_default_easing
---@return ActionInstance
function adam__actions.translate(delta_vector, is_every_frame, delay, ease_function) end
